...
@Repository
public interface  CCPCitiesRepsitory extends CrudRepository<CCPIncident, Integer> {

	@Query(value = "select  cityId  from ccpcities where  cityName=:cityName", nativeQuery = true)
