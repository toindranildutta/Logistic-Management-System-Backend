...
public class CCPSigningService {
	...
	public CCPSigning checkUndertaking ( UserIdRequest userIdObj) {
	...
	public CCPSigning checkDeclaration(UserIdRequest userIdObj) {
	...
	public CCPSigning checkPolicy(UserIdRequest userIdObj) {
