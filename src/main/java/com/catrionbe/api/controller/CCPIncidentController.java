...
public class CCPIncidentController {
	...
	@RequestMapping(value = "/saveincident", method = RequestMethod.POST, headers = "Accept=application/json")
	...
	@RequestMapping(value = "/listallarchivedincidents", method = RequestMethod.GET)
	public ResponseEntity<?> listallarchivedincidents(@RequestParam(defaultValue = "0") final Integer pageNumber,
			@RequestParam(defaultValue = "10") final Integer size) throws Exception {
	...
	public ResponseEntity<?> listsearchincident(@RequestParam(defaultValue = "test") final String searchText,
	...
	public ResponseEntity<?> searchallactiveincidents(@RequestParam(defaultValue = "test") final String searchText,
			@RequestParam(defaultValue = "0") final Integer pageNumber,
			@RequestParam(defaultValue = "10") final Integer size) throws Exception {
	...
	public ResponseEntity<?> searchallarchivedincidents(@RequestParam(defaultValue = "test") final String searchText,
			@RequestParam(defaultValue = "0") final Integer pageNumber,
			@RequestParam(defaultValue = "10") final Integer size) throws Exception {
	 ...
	 * public ResponseEntity<?> listallfeedback() throws Exception { return
	 * ResponseEntity.ok(ccpFeedbackService.findAllElements()); }
	 * 
	 * @RequestMapping(value = "/listallarchivedfeedback", method =
	 * RequestMethod.GET) public ResponseEntity<?> listallarchivedfeedback() throws
	 * Exception { return
	 * ResponseEntity.ok(ccpFeedbackService.listallarchivedfeedback()); }
	 * 
	 * @RequestMapping(value = "/acceptdeclaration", method = RequestMethod.POST)
	 * public ResponseEntity<?> acceptDeclaration(@RequestBody CCPSigningRequest
	 * signObj) throws Exception { return
	 * ResponseEntity.ok(objCCPSigningService.acceptDeclaration(signObj)); }
	 * 
	 * @RequestMapping(value = "/acceptpolicy", method = RequestMethod.POST) public
	 * ResponseEntity<?> acceptPolicy(@RequestBody CCPSigningRequest signObj) throws
	 * Exception { return
	 * ResponseEntity.ok(objCCPSigningService.acceptPolicy(signObj)); }
	 * 
	 * @RequestMapping(value = "/checkundertaking", method = RequestMethod.POST)
	 * public ResponseEntity<?> checkUndertaking(@RequestBody UserIdRequest
	 * userIdObj) throws Exception { return
	 * ResponseEntity.ok(objCCPSigningService.checkUndertaking(userIdObj)); }
	 * 
	 * @RequestMapping(value = "/checkdeclaration", method = RequestMethod.POST)
	 * public ResponseEntity<?> checkDeclaration(@RequestBody UserIdRequest
	 * userIdObj) throws Exception { return
	 * ResponseEntity.ok(objCCPSigningService.checkDeclaration(userIdObj)); }
	 * 
	 * @RequestMapping(value = "/checkpolicy", method = RequestMethod.POST) public
	 * ResponseEntity<?> checkPolicy(@RequestBody UserIdRequest userIdObj) throws
	 * Exception { return
	 * ResponseEntity.ok(objCCPSigningService.checkPolicy(userIdObj)); }
	 */
}
