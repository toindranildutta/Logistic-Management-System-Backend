...
public class CCPFeedbackController {
	...
	public ResponseEntity<?> searchallactivefeedback(@RequestParam(defaultValue = "test") final String searchText,
			@RequestParam(defaultValue = "0") final Integer pageNumber,
			@RequestParam(defaultValue = "10") final Integer size) throws Exception {
	...
	public ResponseEntity<?> searchallarchivedfeedback(@RequestParam(defaultValue = "test") final String searchText,
			@RequestParam(defaultValue = "0") final Integer pageNumber,
			@RequestParam(defaultValue = "10") final Integer size) throws Exception {
