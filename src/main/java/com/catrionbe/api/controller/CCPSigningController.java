...
public class CCPSigningController {
	...
	/*
	 * @RequestMapping(value="/showCertificate", method = RequestMethod.GET) public
	 * ResponseEntity<?> displaycertificate(@PathVariable("prNumber") String
	 * prNumber) throws Exception { System.out.println(" controller "); return
	 * ResponseEntity.ok(objCCPSigningService.displaycertificate(prNumber)); }
	 */
}
